...
Theorem wp_goal :
  forall (t:addr -> Numbers.BinNums.Z) (t1:addr -> Numbers.BinNums.Z)
    (a:addr) (a1:addr) (a2:addr) (a3:addr) (a4:addr) (a5:addr)
    (i:Numbers.BinNums.Z) (i1:Numbers.BinNums.Z),
  is_sint32_chunk t1 -> is_sint32_chunk t -> P_permutation t t1 a1 a4 i1 ->
  P_permutation t t1 a a3 i -> P_count_combine t1 a i a1 i1 a2 ->
  P_permutation t t1 a2 a5 (i + i1)%Z -> P_count_combine t a3 i a4 i1 a5.
Proof.
intros M2 M1 a1 b1 out1 a2 b2 out2 len_a len_b.
intros ? ? perm_b perm_a H perm_out.
intros elem elem_int.
rewrite <- perm_a; trivial.
rewrite <- perm_b; trivial.
rewrite <- perm_out; trivial.
apply H; trivial.
